  ...
  return (
    <div style={pageWrap}>
      <div style={inner}>
        ...
        <h1 style={{ color: '#cccccc', fontSize: 18, fontWeight: 'normal', margin: '0 0 6px', letterSpacing: 1 }}>
          start here
        </h1>
        <p style={{ color: '#555', fontSize: 12, margin: '0 0 48px', letterSpacing: '0.05em' }}>
          new to this? good place to be.
        </p>

        {/* what is reticulum */}
        <div style={{ marginBottom: 32 }}>
          <p style={{ color: TEAL, fontSize: 13, margin: '0 0 8px' }}>what is reticulum?</p>
          <p style={{ color: '#aaaaaa', fontSize: 14, lineHeight: 1.75, margin: '0 0 10px', whiteSpace: 'pre-line' }}>
        ...
        {/* what is this node */}
        <div style={{ marginBottom: 32 }}>
          <p style={{ color: TEAL, fontSize: 13, margin: '0 0 8px' }}>what is this node, for you?</p>
          <p style={{ color: '#aaaaaa', fontSize: 14, lineHeight: 1.75, margin: '0 0 8px' }}>
        ...
        {/* what do i need */}
        <div style={{ marginBottom: 32 }}>
          <p style={{ color: TEAL, fontSize: 13, margin: '0 0 8px' }}>what do i need?</p>
          <p style={{ color: '#aaaaaa', fontSize: 14, lineHeight: 1.75, margin: '0 0 8px' }}>
        ...
        {/* first three steps */}
        <div style={{ marginBottom: 32 }}>
          <p style={{ color: TEAL, fontSize: 13, margin: '0 0 8px' }}>first three steps</p>
          {[
            ...
            <div key={i} style={{ marginBottom: 8, paddingLeft: 20, fontSize: 14, color: '#aaaaaa', lineHeight: 1.75, position: 'relative' }}>
